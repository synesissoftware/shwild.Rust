...
- [Historical 0.1.4 boilerplate checklist](#historical-014-boilerplate-checklist)
  - [Cargo packaging](#cargo-packaging)
  - [CI](#ci)
  - [Documentation](#documentation)
  - [Formatting and quality tooling](#formatting-and-quality-tooling)
...
* [x] ~~~narrow `exclude` (drop `.github`)~~~ — **won't fix** (keep
  `exclude = ["target", ".github"]` since 0.1.3) - ✅;
...
Split `src/lib.rs` (~3,450 lines) into multiple source files. **Deferred after
0.1.4**
